...
shinyUI(
  fluidPage(theme = "bootstrap.css",
    ...
    sidebarLayout(
        ...
        br(),
        h3(''),
        selectInput('Player', h4(tags$p(class="text-danger",'Player Name: ')), c(Choose='', PlayerNames), selected = "Robert Covington"),
        h4(''),
        selectInput('metrics', 
                    ...
                    multiple=TRUE, 
                    selectize=TRUE, 
                    selected =  list('Player','GameAvgPTS','GameAvgAST','GameAvgMin','Age')),
    ...
    mainPanel(
      HTML('<div class="alert alert-dismissable alert-info">
            ...
            nearest neighbor cluster</a> algorithm. We recognize that there are some bugs with the axis selection and are working to fix them. Please contact <a href="mailto:peter.j.bertoli@gmail.com?subject=NBA Shiny App" class="alert-link">
